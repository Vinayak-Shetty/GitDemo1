...
public class Dashboard {
	...
	public SelfAccountTransfer completeCoachGuide() throws InterruptedException {
		Thread.sleep(10000);
		nextBtn.click();
		nextBtn.click();
		nextBtn.click();
		...
		nextBtn.click();
		closeBtn.click();
		SelfAccountTransfer selfAccountTransfer = new SelfAccountTransfer(driver);
		return selfAccountTransfer;
